# My Project
This repository consists of the d9-blt-lando-multisite.
...
```
$ composer create-project --no-interaction acquia/drupal-recommended-project d9-blt-lando-multisite
```
...
```
$ git clone git@github.com:<account>/d9-blt-lando-multisite.git
```
6. To ensure that upstream changes to the parent repository may be tracked, add the upstream locally as well.
```
$ git remote add upstream git@github.com:acquia-pso/d9-blt-lando-multisite.git
```
...
Use BLT to setup the site with configuration.
    ...
    $ lando blt setup --site=d9-blt-lando-multisite
...
$ git status
$ git add -p
$ git commit -m"d9-blt-lando-multisite-000: Committing new changes to site."
$ git push --set-upstream origin d9-blt-lando-multisite-000-new-site-change
```
...
* Local site URL: http://d9-blt-lando-multisite.lndo.site
